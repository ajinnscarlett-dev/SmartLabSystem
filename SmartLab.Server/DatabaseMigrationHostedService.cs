...
namespace SmartLab.Server
{
    public sealed class DatabaseMigrationHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            // Development-only first-admin setup for a local test database.
            // Production never creates or resets an Admin account here.
            ...
            if (bootstrapPassword.Length < 6)
            {
                throw new InvalidOperationException(
                    "SmartLab:DevelopmentAdminPassword must be at least 6 characters long.");
            }
